...
class ApexGrandmasterAgent:
    def __init__(self):
        # Best Parameters Found via Full 120-Trial Bayesian Optimization ($99,033.00 Peak)
        self.p = {
            "sell_thresh": 0.7,
            "milk_wool_thresh": 0.5,
            "sell_batch_size": 8,
    ...
    def act(self, obs):
        ...
        # --- Priority 6: Dynamic Market Selling ---
