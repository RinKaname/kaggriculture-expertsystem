"""
Apex Grandmaster Strategy (110k-135k Tier):
- Dynamic Land Expansion: NW -> NE (Day 7-8) -> SW (Day 11-13).
- 14 Animal Engine: 8 Cows + 6 Sheep placed at shed perimeter pastures.
- 40 Strawberry Matrix + 10 Melon Engine with morning fertilization.
- Paced Market Liquidation: Daily Fertilizer ($100), Milk ($160), Wool ($200).
"""
import math
...
class ApexGrandmasterAgent:
    ...
    def act(self, obs):
        ...
        elif len(unlocked_quads) == 2 and money >= 2050 and day <= 18 and len(market_orders) < 10:
            market_orders.append(["BUY_LAND"])
        elif len(unlocked_quads) == 3 and money >= 4100 and day <= 22 and len(market_orders) < 10:
            market_orders.append(["BUY_LAND"])
        ...
        if total_animals < max_target_animals and money >= 750 and day <= 14:
        ...
        # 1. Strawberry Matrix (Priority 1 in Days 4-16)
        ...
        # 2. Melon Engine (Priority 2 in Days 0-18)
