...
Apex Grandmaster V6 vs Previous Main (43k-46k)
"""
from kaggle_environments import make
from test_apex_grandmaster_v6 import ApexGrandmasterAgentV6
from main import agent as prev_agent

print("=" * 65)
print("HEAD-TO-HEAD MATCHUP: Apex Grandmaster V6 vs Previous Main")
print("=" * 65)

for g in range(4):
    p0_obj = ApexGrandmasterAgentV6()
    p1_obj = ApexGrandmasterAgentV6()
