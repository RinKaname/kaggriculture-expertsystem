"""
Apex Grandmaster Strategy V5 (120k-135k Meta):
- Proper Shed Drop using ["PLACE", item, count] at shed access tiles [(4,4), (5,4), (4,5), (5,5)].
- Animal Hub + Daily Fertilizer Cash Injection ($400/day early game).
- High Yield Strawberry/Melon Matrix + Paced Selling.
"""
import math
...
def agent(obs):
    ...
    if _agent_inst is None or obs.get("step", 0) == 0:
        _agent_inst = ApexGrandmasterAgentV5()
