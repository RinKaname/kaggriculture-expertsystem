"""
Test Instant Day 0 NE Unlock:
- Buy NE on Day 0 Turn 0 (Costs $1,000, leaves $2,000 starting cash).
- Gives 50 tiles on Day 0 instead of 25 tiles!
- Buy SW ($2,000) on Day 4-7.
- Buy SE ($4,000) on Day 8-12.
"""
import math
...
class InstantNEAgent:
    ...
    def act(self, obs):
        ...
        if hour == 0:
            # 1. Day 0 Immediate NE Unlock & Fast Expansion
            if unlocked_quads == 1 and money >= 1000 and day <= 4:
                market_orders.append(["BUY_LAND"])
            elif unlocked_quads == 2 and money >= 2100 and day <= 8:
                market_orders.append(["BUY_LAND"])
            elif unlocked_quads == 3 and money >= 4200 and day <= 12:
                market_orders.append(["BUY_LAND"])
            ...
            if day <= 16 and avail_money >= 160:
                melon_target = 40 if num_tiles >= 75 else (22 if num_tiles >= 50 else 10)
            ...
            if day <= 14 and avail_money >= 200:
                straw_target = 18 if num_tiles >= 75 else 8
