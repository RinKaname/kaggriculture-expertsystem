"""
Turbo Grandmaster Agent:
- Land: 100-tile full expansion (NW -> NE -> SW -> SE)
- Multi-Worker Fleet: 1 worker per 6 tiles
- High-Yield Portfolio:
  - Early-to-Mid Melons (planted Day 0-16, harvesting up to $250 base each!)
  - Ongoing Tomatoes & Strawberries (high base price, multi-yield)
  - Livestock Sanctuary (Cows producing $160 Milk + free Fertilizer)
  - High-velocity Carrot cash generation
  - Season-end complete liquidation
"""
import math
...
class TurboAgent:
    ...
    def act(self, obs):
        ...
        if hour == 0:
            ...
            # Melon takes 12 days to mature and gives 6 yield = $1500 revenue!
...
if __name__ == "__main__":
    ...
    print(f"Average Turbo Score: {sum(scores)/len(scores):,.2f}")
